...
# Type alias for method handlers: handler(params, context) -> result dict
...
class JSONRPCRouter:
    ...
    Handlers are async callables that accept a params dict and context, returning a result dict.
    """
    ...
    def register(self, method: str, handler: MethodHandler) -> None:
        ...
        Args:
            method: The method name (e.g., "tools/list", "tasks/send").
            handler: Async callable(params, context) -> result dict.
        """
